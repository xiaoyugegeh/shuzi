        ...
        <div className="border-t border-zinc-700/30 px-3 py-2 space-y-2">
          {citations.map((citation, index) => (
            <div
              ...
              className="flex items-start gap-2 rounded-md bg-zinc-900/40 p-2.5"
            >
              <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded bg-amber-500/15 text-[10px] font-bold text-amber-400">
                {index + 1}
              </div>
